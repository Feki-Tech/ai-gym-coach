...
COPY pose_coach.py coach_chat.py coach_profile.py coach_calendar.py coach_dashboard.py coach_sensors.py coach_ops.py coach_eval.py coach_devices.py coach_hud.py parity_fixtures.py prop_tests.py ./
